...
// Coneccion entre las acciones y reducers
// E inicializamos el estado (opcional)
// const store = createStore(reducer, initialState);

// render(<nuestroComponente>, <DondeLoEmpujaremos>)
ReactDOM.render(
  //FIXME:
  // 2. Pasamos nuestro store a Provider, este nos permite:
  // Encapsular componentes por medio de un connect
  // Transmitir la informacion que necesitemos del store a cada componente
